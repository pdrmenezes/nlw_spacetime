    ...
    >
      <View className="mt-4 flex-row items-center justify-between">
        ...
        <Link href="/memories" asChild>
          <TouchableOpacity className="h-10 w-10 items-center justify-center rounded-full bg-spacetime_purple-500">
      ...
      <View className="mt-6 space-y-6">
        <View className="flex-row items-center gap-2">
          ...
          />
          <Text className="font-body text-base text-spacetime_gray-200">
        ...
        >
          <View className="flex-row items-center gap-2">
            ...
            <Text className="font-body text-sm text-spacetime_gray-200">
